...
>
> **Статус на 2026-08-02** (сессия `docs/prompts/2026-08-02-tech-debt-and-strategy.md`):
> закрыты A4 (только docstrings), A7, B1, C3, C6. Решения приняты и записаны
> в `docs/progress.md` по A6/S4 (**удалить**), C1/S3 (**весь `app/` за один цикл**)
> и по всем пунктам Волны 7 (S5). Остальное — как было.
