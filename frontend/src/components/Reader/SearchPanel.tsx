          ...
          >
            <div className="flex items-center gap-1.5 xs:gap-2 px-2 xs:px-3 py-2">
              <input
                ...
                className="flex-1 min-w-0 bg-muted rounded-lg px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-primary/50"
                autoComplete="off"
                autoCorrect="off"
                spellCheck={false}
              />
