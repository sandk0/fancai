  ...
  return (
    ...
    >
      <Drawer.Portal>
        ...
        <Drawer.Content className="bg-background flex flex-col rounded-t-2xl max-h-[90vh] fixed bottom-0 left-0 right-0 z-50 outline-hidden focus-visible:ring-2 focus-visible:ring-primary">
          {/* Handle bar */}
