...
test.describe('PWA Features', () => {
  ...
  test.describe('Caching', () => {
    ...
    test('должен использовать кешированные ассеты при повторной загрузке', async ({ page }) => {
      ...
      // 304 — такой же успех, как 200, и для этого теста даже более прямой:
      // движок сходил на ревалидацию и получил «не изменилось», то есть
      // ассет взят из кеша. Chromium отдаёт 200 (memory cache без
      // ревалидации), WebKit — 304. Ждать ровно 200 значило требовать
      // конкретную стратегию кеширования вместо самого факта кеша.
