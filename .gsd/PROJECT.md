...
- **M001 v1.0 — Готовность к продакшену** (2026-03-01 → 2026-03-09, 9 дней). 9 фаз, 169 коммитов, 910 файлов, +75K/-68K строк, 52 требования validated. Безопасность, мониторинг, миграция AI на OpenRouter, очистка NLP, Entity Wiki, ридер с закладками/поиском.
- **M002 v1.1 — Reader Mobile / PWA** (2026-03-09, 1 день). 6 фаз, 13 планов, 21 требование. +9674/-2680 строк, 74 файла. Follow-finger свайпы, gesture controller, мобильный UI, iOS viewport, PWA, фикс описаний.
...
**Известный техдолг:**
- 2 сломанных теста: EpubReader.test.tsx (устаревшие моки), ErrorBoundary.test.tsx (устаревшие текстовые проверки)
...
- CLN-01: useTouchNavigation.ts, IOSTapZones.tsx, useFollowFingerSwipe.ts — файлы существуют, но были реинтегрированы в gesture controller (M002). Требование требует пересмотра.
