...
plan: 01
subsystem: ui
tags: [vaul, react, i18n, bottom-sheet, epub-reader, image-generation]

# Dependency graph
requires:
  - phase: 17-mobile-layout-polish
    provides: Vaul MobilePanel wrapper, panel dismiss flow, snap points pattern
  - phase: 08-notes
    provides: DescriptionDrawer base component, EntityPopup component
provides:
...
affects: [19-02-description-entity-popup]

# Tech tracking
tech-stack:
  added: []
  patterns:
    - "Vaul bottom sheet with snap points for compact entity/description views"
    - "useGenerateImage mutation integrated in drawer component"
