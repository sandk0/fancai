...
plan: 02
subsystem: ui
tags: [css, gesture-controller, epub-reader, reader-settings, zustand, i18n]

# Dependency graph
requires:
  - phase: 19-description-entity-popup
    provides: DescriptionDrawer, EntityBottomSheet, EpubReader wiring (plan 01)
  - phase: 16-swipe-navigation
    provides: useGestureController with getInteractiveType and iOS overlay
provides:
...
tech-stack:
  added: []
  patterns:
    - "onCenterTap returns boolean to prevent UI toggle when interactive element found"
    - "Entity detection in handleCenterTap via .entity-mention + data-entity-id"
...
requirements-completed: [ENT-02, ENT-01]
