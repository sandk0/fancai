...
plan: 03
subsystem: ui
tags: [react, reader, footer, progress-bar, epub, motion]

requires:
  - phase: 17-shapka-i-paneli
    provides: "Адаптивная шапка с overflow menu (план 01), snap points (план 02)"
provides:
...
affects: [reader-ui, reader-header]

tech-stack:
  added: []
  patterns: [footer-with-header-sync, chapter-page-tracking]
