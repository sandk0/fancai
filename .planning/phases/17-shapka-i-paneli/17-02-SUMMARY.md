...
plan: 02
subsystem: ui
tags: [react, vaul, snap-points, mobile, responsive, autofocus]

# Dependency graph
requires:
  - phase: 17-shapka-i-paneli
    provides: Адаптивная шапка с overflow menu и TocSidebar с controlled tabs
provides:
...
affects: [18-PLAN, 19-PLAN]

# Tech tracking
tech-stack:
  added: []
  patterns:
    [isMobile guard для autofocus, responsive Tailwind classes для 320px]
...
requirements-completed: [PNL-01, PNL-02, HDR-02]
