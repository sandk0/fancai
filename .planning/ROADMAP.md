...
- [ ] **Phase 4: Обслуживание инфраструктуры** — Развернуть мониторинг-стек (Netdata + VictoriaMetrics + Uptime Kuma + Dozzle + Flower), активировать бизнес-метрики, обновить зависимости, оптимизировать PostgreSQL для 32GB RAM
...
| 4. Обслуживание инфраструктуры | 0/3 | Не начата | - |
