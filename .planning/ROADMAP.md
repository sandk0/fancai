...
- [x] 12-01-PLAN.md — useVisualViewportHandler хук + safe area аудит и исправления overlay-компонентов
- [x] 12-02-PLAN.md — PWA standalone navigation + onboarding подсказка + iOS-верификация
