...
Plans:
- [ ] 17-01-PLAN.md -- Адаптивная шапка с overflow menu + перенос Инфо в TocSidebar
- [ ] 17-02-PLAN.md -- Snap points панелей + autofocus fix + SearchPanel на 320px
...
| 17. Шапка и панели | 1/2 | In Progress|  | - |
