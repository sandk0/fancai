...
- [x] **Phase 19.1: UAT-фиксы** - Точечные исправления 5 UAT-багов: выделение при тапе, прозрачные drawer-ы, edge taps, задержка заметок (INSERTED) (completed 2026-03-11)
...
| 19.1. UAT-фиксы                          | 2/2 | Complete    | 2026-03-11 | -          |
