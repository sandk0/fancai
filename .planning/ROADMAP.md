...
- [x] 07-01-PLAN.md — Централизованная утилита маппинга ошибок + i18n ключи + перевод ErrorBoundary + интеграция в EpubReader/ReaderOverlays (UX-02, UX-04)
- [x] 07-02-PLAN.md — ParsingOverlay: обработка ошибок парсинга + retry. ExtractionIndicator: error state + retry + подключение в Reader (UX-03, UX-05)
