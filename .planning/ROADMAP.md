...
- [ ] **Phase 5: Стабилизация AI и очистка техдолга** — Добавить circuit breaker для OpenRouter, настроить бэкап БД, очистить остаточный техдолг (мёртвый код, устаревшие провайдеры в метаданных, стале конфиги), исправить осиротевшие описания
- [ ] **Phase 6: Качество Entity Wiki** — Снизить порог нечёткого сравнения для русских имён, реализовать рекурсивный reduce для больших книг, добавить исчерпывающие тесты спойлер-защиты и ConsistencyManager
- [ ] **Phase 7: Обработка ошибок и UX** — Стандартизировать состояния ошибок, добавить индикаторы загрузки при навигации, улучшить UX восстановления после сбоев AI
...
- [ ] 05-01-PLAN.md — Circuit breaker для OpenRouter API + очистка данных книги при переобработке (AI-02, UX-06)
- [ ] 05-02-PLAN.md — Автоматический бэкап PostgreSQL + очистка мёртвого кода после миграции (DEPLOY-04)
...
| 5. Стабилизация AI и техдолг       | 1/2 | In Progress|  |
