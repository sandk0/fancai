...
- [ ] 06-01-PLAN.md — Fuzzy matching fix + рекурсивный batched reduce + тесты ConsistencyManager (WIKI-01, WIKI-02, WIKI-03)
- [ ] 06-02-PLAN.md — Исчерпывающие тесты спойлер-фильтрации: Hypothesis PBT + unit-тесты notes/edges/milestones (WIKI-04)
...
| 6. Качество Entity Wiki            | 0/2              | Planned   | -          |
