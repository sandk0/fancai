...
Plans:
- [ ] 29-01-PLAN.md — Docker инфраструктура: Dockerfile.celery + docker-compose.prod.yml (pgvector, Celery 4GB, nlp_models volume)
...
| 29. Docker и DB инфраструктура | v1.4 | 0/2 | Not started | - |
