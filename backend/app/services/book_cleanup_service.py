...
async def cleanup_book_data(db: AsyncSession, book_id: UUID) -> dict[str, Any]:
    ...
    chapter_ids: list[UUID] = chapter_ids_result.scalars().all()
    ...
    avatar_paths: list[str] = avatar_result.scalars().all()
    ...
    if chapter_ids:
        ...
        result["descriptions_deleted"] = desc_result.rowcount
    ...
    result["entities_deleted"] = entity_result.rowcount
