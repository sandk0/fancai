...
description: Switch model profile for GSD agents (quality/balanced/budget/adaptive/inherit)
argument-hint: <profile (quality|balanced|budget|adaptive|inherit)>
model: haiku
allowed-tools:
  - Bash
---
