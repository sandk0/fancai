...
```bash
cp "/Users/sandk/Documents/GitHub/fancai/.claude/get-shit-done/USER-PROFILE.md" "/Users/sandk/Documents/GitHub/fancai/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/Users/sandk/Documents/GitHub/fancai/.claude/USER-PROFILE.backup.md"
```
