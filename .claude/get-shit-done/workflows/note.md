...
- **Global scope**: `/Users/sandk/Documents/GitHub/fancai/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/sandk/Documents/GitHub/fancai/.claude/notes/`)
...
2. Glob `/Users/sandk/Documents/GitHub/fancai/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/sandk/Documents/GitHub/fancai/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/sandk/Documents/GitHub/fancai/.claude/notes/` — works in any directory
