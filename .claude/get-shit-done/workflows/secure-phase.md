...
```
Task(
  prompt="Read /Users/sandk/Documents/GitHub/fancai/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/sandk/Documents/GitHub/fancai/.claude/get-shit-done/templates/SECURITY.md`
