...
### EpubReader Decomposition
- EpubReader.tsx is well-decomposed into 25+ hooks — maintain this pattern
- Before adding logic to EpubReader.tsx, extract it into a hook first
- 14 useState calls remain — consider useReducer if adding more modal state
